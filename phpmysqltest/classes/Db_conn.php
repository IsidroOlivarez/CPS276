...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'iolivarez';//this will be your WCC username
      $dbUsr = 'iolivarez';//this will be your WCC username
      $dbPass = 'gVhSjPAaPDrnC2Q';//this will be the password found in the video.
